...
enum opcode
{
	LIT, OPR, LOD, STO, CAL, INT, JMP, JPC, EXT, STA, LTA, RET, JNZ, JZ, PRT, PRTP, RAND
};
...
char prtmsg[10][10];		//to record print message.
int prti = 0;		//prtmsg array pointer
int prtj = 0;
...
{
	"LIT", "OPR", "LOD", "STO", "CAL", "INT", "JMP", "JPC", "EXT", "STA", "LTA", "RET", "JNZ", "JZ", "PRT", "PRTP"
};
